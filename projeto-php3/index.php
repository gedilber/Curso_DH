        ...
        <div class="row">
            <?php foreach($filmes as $key => $value): ?>
                <div class="border mb-5 col-12 col-md-6 col-lg-4">
                    ...
                    <button type="button" class="btn btn-primary mb-4" data-toggle="modal" data-target="#modalExemplo<?php echo $key ?>">
                    Comprar
                    </button>
                    
                    <!-- Modal -->
                       
                        <div class="modal fade" id="modalExemplo<?php echo $key?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
