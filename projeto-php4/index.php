        ...
        <div class="row">
            <?php foreach($filmes as $key => $value): ?>
                <div class="border mb-5 col-12 col-md-6 col-lg-4">
                    ...
                    <button type="button" class="btn btn-info mb-4" data-toggle="modal" data-target="<?php echo '#'.str_replace(' ','',$value["titulo"]); ?>">
                        Visualizar
                    </button>
                    <form action="compra.php" method="GET" class="d-inline-block">
                    <input type="hidden" value="<?php echo $value["titulo"]; ?>" name="titulo">
                    <button type="submit" class="btn btn-primary mb-4" data-toggle="modal" data-target=" " >
                        Comprar
                    </button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p><i class="fa fa-user mr-2"></i> Sinopse: <?php echo $value["sinopse"]; ?> </p>
                                    <p><i class="fa fa-bookmark mr-2"></i> Ator Principal: <?php echo $value["ator_principal"]; ?> </p>
                                    <p><i class="fa fa-clock-o mr-2"></i> Duracao: <?php echo $value["duracao"]; ?></p>
                                    <p><i class="fa fa-american-sign-language-interpreting mr-2"></i> Gênero: <?php echo $value["genero"]; ?></p>
